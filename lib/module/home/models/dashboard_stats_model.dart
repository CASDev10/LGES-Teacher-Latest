...
DashboardStatsModel dashboardStatsModelFromJson(dynamic str) => DashboardStatsModel.fromJson(str);
...
class DashboardStatsModel {
    ...
    DashboardStatsModel copyWith({
        ...
        DashboardStatsModel(
            ...
            studentAttendanceStatList: studentAttendanceStatList ?? this.studentAttendanceStatList,
            employeeAtteandanceStatList: employeeAtteandanceStatList ?? this.employeeAtteandanceStatList,
    ...
    factory DashboardStatsModel.fromJson(Map<String, dynamic> json) => DashboardStatsModel(
        ...
        studentAttendanceStatList: json["StudentAttendanceStatList"] == null
            ? null
            : List<NdanceStatList>.from(json["StudentAttendanceStatList"].map((x) => NdanceStatList.fromJson(x))),
        employeeAtteandanceStatList: json["EmployeeAtteandanceStatList"] == null
            ? null
            : List<NdanceStatList>.from(json["EmployeeAtteandanceStatList"].map((x) => NdanceStatList.fromJson(x))),
        diaryStatList: json["DiaryStatList"] == null
            ? null
            : List<DiaryStatList>.from(json["DiaryStatList"].map((x) => DiaryStatList.fromJson(x))),
        ucUser: json["UC_User"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "EmployeeAtteandanceStatList": employeeAtteandanceStatList == null
            ? null
            : List<dynamic>.from(employeeAtteandanceStatList!.map((x) => x.toJson())),
...
class DiaryStatList {
    ...
    DiaryStatList copyWith({
        int? diariesSent,
    }) => 
        DiaryStatList(
            diariesSent: diariesSent ?? this.diariesSent,
        );

    factory DiaryStatList.fromJson(Map<String, dynamic> json) => DiaryStatList(
        diariesSent: json["DiariesSent"],
    );

    Map<String, dynamic> toJson() => {
        "DiariesSent": diariesSent,
    };
}
