...
enum FetchObservationAreasStatus { none, loading, success, failure }
...
class FetchObservationAreasState {
  ...
  FetchObservationAreasState({
    required this.fetchObservationAreasStatus,
    required this.failure,
    required this.observationModel,
  });
  ...
  FetchObservationAreasState copyWith({
    ...
    return FetchObservationAreasState(
      fetchObservationAreasStatus:
          fetchObservationAreasStatus ?? this.fetchObservationAreasStatus,
