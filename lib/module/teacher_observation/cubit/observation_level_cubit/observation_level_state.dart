...
enum ObservationLevelStatus { none, loading, success, failure }
...
class ObservationLevelState {
  ...
  ObservationLevelState({
    required this.observationLevelStatus,
  ...
  ObservationLevelState copyWith({
    ...
    return ObservationLevelState(
      observationLevelStatus:
          observationLevelStatus ?? this.observationLevelStatus,
