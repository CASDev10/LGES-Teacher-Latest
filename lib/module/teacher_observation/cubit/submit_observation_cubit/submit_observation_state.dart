...
enum SubmitObservationStatus { none, loading, success, failure }
...
class SubmitObservationState {
  ...
  SubmitObservationState({
    required this.submitObservationStatus,
  ...
  SubmitObservationState copyWith({
    ...
    return SubmitObservationState(
      submitObservationStatus:
          submitObservationStatus ?? this.submitObservationStatus,
