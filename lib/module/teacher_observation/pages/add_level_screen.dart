...
import 'package:lges_teacher_app/module/teacher_observation/widgets/level_tile.dart';
...
class _AddLevelScreenState extends State<AddLevelScreen> {
  ...
  Widget build(BuildContext context) {
    return BaseScaffold(
      ...
      body: Container(
        ...
        child: BlocBuilder<ObservationLevelCubit,
            ...
            if (observationLevelState.observationLevelStatus ==
              ...
              return Column(
                children: [
                  ...
                  BlocConsumer<AddUpdateDeleteLevelCubit,
                    ...
                    builder: (context, state) {
                      return Expanded(
                          child: observationLevelState.levels.isNotEmpty
                              ? ListView.builder(
                                        ...
                                        if (value) {
                                          showAddLevel(
                                              ...
                                              observationLevelState
                                                  .levels[index].level,
                                              observationLevelState
                                                  .levels[index].levelId
                                                  .toString(),
                                              true, onButtonPressYes: (value) {
                                            context.read<
                                                ObservationLevelCubit>()
                                              ..getObservationLevels();
                                          });
                                        } else {
              ...
              return Center(
                child: Text(observationLevelState.failure.message),
              );
            }
            return SizedBox();
          },
  ...
  void showAddLevel(
      BuildContext context, String level, String levelId, bool isEditButtonClick,
                            ...
                            onPressed: () {
                              if (addLevelTextController.text
                                ...
                                if (isEditButtonClick) {
                                  ...
                                  context.read<AddUpdateDeleteLevelCubit>()
                                    ..addObservationLevel(addLevelTextController
                                        .text
                                        .trim()
                                        .toString());
                                }
